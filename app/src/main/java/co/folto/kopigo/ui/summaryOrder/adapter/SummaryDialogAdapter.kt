...
/**
 * Created by Daniel on 7/3/2017 for Kopigo project.
 */
class SummaryDialogAdapter(var products: MutableList<Product>): RecyclerView.Adapter<SummaryDialogAdapter.PlaceHolder>() {
